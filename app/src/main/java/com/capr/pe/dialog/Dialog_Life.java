...
import com.capr.pe.fragments.Fragment_Entrar;
import com.capr.pe.maven.Maven;
import com.capr.pe.maven.R;
import com.capr.pe.operation.Operation_Registrar_Empresa;
...
public class Dialog_Life extends AlertDialog implements View.OnClickListener{
    ...
    public void onClick(View v) {
        try {
            ...
            Log.e("USUARIO",new Session_Manager(getContext()).getSession().getJsonObject().toString());
