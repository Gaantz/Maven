...
import com.capr.pe.fragments.Fragment_Detalle_Local_Life;
 ...
 */
public class View_Local_Life extends RelativeLayout implements View.OnClickListener{

    private Local_DTO local_dto;

    public View_Local_Life(Context context, Local_DTO local_dto) {
        super(context);
        this.local_dto = local_dto;
        initView();
    }

    public View_Local_Life(Context context, AttributeSet attrs, Local_DTO local_dto) {
        super(context, attrs);
        this.local_dto = local_dto;
        initView();
    }

    public View_Local_Life(Context context, AttributeSet attrs, int defStyle, Local_DTO local_dto) {
    ...
    private void initView(){
        ...
        try {
            ...
            JSONArray jsonArray = jsonObject.getJSONArray("ListaCuponesLife");
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if(beneficio.equals("0")){
                    ...
                    //findViewById(R.id.img_cupon_azul).setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        ((Maven)getContext()).getSupportFragmentManager().beginTransaction().add(R.id.container, Fragment_Detalle_Local_Life.newInstance((Local_DTO) getTag()),"fragment_informacion").addToBackStack("a").commit();
    }
