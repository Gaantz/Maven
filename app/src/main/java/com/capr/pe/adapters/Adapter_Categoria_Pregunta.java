 ...
 */
public class Adapter_Categoria_Pregunta extends BaseAdapter {
    ...
    public Adapter_Categoria_Pregunta(Context context, ArrayList<Categoria_DTO> categoria_dtos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_categoria_pregunta, parent, false);
            holder = new Holder();
